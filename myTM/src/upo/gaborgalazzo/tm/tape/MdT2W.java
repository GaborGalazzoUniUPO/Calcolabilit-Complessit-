...
import static it.uniupo.mdtLib.EnvironmentStaticInterface.*;

public class MdT2W implements MdTInterface {
	...
	MdT2W(TransitionTable tt){
		workEnv = DynamicEnvironment.getInstance();
		currentState = workEnv.getInitialState();
		tape = new TwoWayTape();			///change this line to change the kind of tape used
		transitionTable = tt;
	}
